...
$stmt = $conn->prepare("INSERT INTO checklist_items (category_id, item_name, assigned_to, status, note) VALUES (?, ?, ?, ?, ?)");
$stmt->bind_param("isiss", $category_id, $item_name, $assigned_to, $status, $note);
